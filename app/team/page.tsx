...
export default function TeamPage() {
  ...
  const team = [
    ...
    },
    {
      id: 8,
      name: "Priye Horsfall",
      role: "International Brand Ambassador (Turkish Republic)",
      expertise: ["Brand Strategy", "International Relations", "Market Expansion"],
      image: "/priye-horsfall-ambassador.jpg",
    },
    {
      id: 9,
      name: "Reevs Akwa",
